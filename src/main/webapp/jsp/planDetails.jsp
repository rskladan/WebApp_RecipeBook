    ...
    <div class="m-4 p-3 width-medium ">
      <div class="dashboard-content border-dashed p-3 m-4">
        ...
        <div class="schedules-content">
          ...
          <c:forEach var="entryDay" items="${dayMap}">
            <table class="table">

              <thead>
              <tr class="d-flex">
                <th class="col-2"><c:out value="${entryDay.key}"/></th>
                <th class="col-7"></th>
                <th class="col-1"></th>
                <th class="col-2"></th>
              </tr>
              ...
              <c:forEach var="planDetails" items="${planDetails}">
                <c:if test="${planDetails.dayName.equals(entryDay.key)}">
