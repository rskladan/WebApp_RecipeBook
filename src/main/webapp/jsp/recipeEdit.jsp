                ...
                <div class="mt-4 ml-4 mr-4">
                    ...
                    <form method="post" action="/app/recipe/edit">
                        <div class="row border-bottom border-3">
                            <input type="text" name="recipeID" value="${recipe.id}" class="d-none">
                            <input type="text" name="created" value="${recipe.created}" class="d-none">
                        ...
                        <table class="table borderless">
                            ...
                            <tr class="d-flex">
                                ...
                                <td class="col-7"> <textarea class="w-100 p-1" name="recipeDescription" rows="5">${recipe.description}</textarea></td>
                            </tr>
                            <tr class="d-flex">
                                <th scope="row" class="col-2">Przygotowanie (minuty)</th>
                                <td class="col-3">
                                    <input class="p-1" name="preparationTime" type="number" value="${recipe.preparation_time}">
                                </td>
                            </tr>
                            </tbody>
                        </table>
