...
<div class="m-4 p-3 width-medium">
    <div class="dashboard-content border-dashed p-3 m-4 view-height">
        ...
        <form method="post" action="/app/plan/edit">
            <input type="text" name="planID" value="${plan.id}" class="d-none">
            ...
            <div class="schedules-content">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input class="form-control" value="${plan.name}" name="planName" id="planName"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                                    <textarea class="form-control" name="planDescription" rows="5" id="planDescription"
